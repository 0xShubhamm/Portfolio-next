...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[500px] max-w-6xl w-full  items-center justify-center  rounded-lg   "
      ref={containerRef}
    >
      <div className="flex size-full flex-col  max-h-[200px] items-stretch justify-between gap-10">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <div ref={div4Ref} className="bg-white p-6 rounded-full border-2 z-10">




             <h1 className=" text-4xl text-center font-panchang font-bold">Web <AuroraText colors={["#FF0080", "#7928CA", "#0070F3", "#38bdf8"]} >Developer</AuroraText>  </h1>
