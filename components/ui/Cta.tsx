...
export default function () {
    return (
        <div className='flex justify-center  gap-4 w-full text-2xl'>
            <button className='px-6 w-1/4 py-4 bg-black text-white rounded-full flex items-center justify-center'>
            ...
            <button className='px-10 w-1/4 py-4 bg-black text-white rounded-full'>
                LinkedIn
            </button>
